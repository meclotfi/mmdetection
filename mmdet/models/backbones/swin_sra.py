...
from mmcv.cnn import build_norm_layer, constant_init, trunc_normal_init, Conv2d
...
from ..utils.transformer import PatchEmbed, PatchMerging,nchw_to_nlc, nlc_to_nchw
...
class W_SpatialReductionAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.wsa=ShiftWindowMSA(embed_dims=embed_dims,num_heads=num_heads,window_size=window_size,shift_size=shift_size,attn_drop_rate=attn_drop,qkv_bias=qkv_bias)
